...
def main(stamm):
	...
	relations_full = read_relations(file_relations) 	# liste mit (a_id,r_type,rel_y_n,e1,e2)
	entities_full = read_entities(file_entities)		# liste mit (a_id,ex,e_type,e1_start,e_end,e_text)
	abstracts_full = read_abstracts(file_abstracts)		# liste mit (a_id,a_title,a_a)
	#erstes ziel
