...
def main(name_val_folder):
    files = os.listdir("../ds/cross_val/" + str(name_val_folder))
    files.sort()  
    #print(files)
    for i in files:
        print(i)
        ein_run("cross_val/"+ str(name_val_folder)+ "/" + str(i),"cross_val/"+ str(name_val_folder)+ "/" + str(i))
